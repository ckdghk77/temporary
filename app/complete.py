...
def complete():
    ...
    ## Case 4: visit complete page with previous success.
        ...
        #url = "https://connect.cloudresearch.com/participant/project/edea944375e14364a97081ef51472247/complete?workerId=%s&assignmentId=%s&hitId=%s&a=%s&tp_a=%s&b=%s&tp_b=%s&c=%s&tp_c=%s" %(session['workerId'], session['assignmentId'], session['hitId'], session['a'], session['tp_a'], session['b'], session['tp_b'], session['c'], session['tp_c'])
        url = "https://connect.cloudresearch.com/participant/project/edea944375e14364a97081ef51472247/complete"
