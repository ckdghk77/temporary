...
def forward(data_loader, eval=False, save_img=False, save_feature=False, root_img_dir="incre", device="cuda") :
        ...
        for session_idx in range(5) :
            ...
            (exp_xs,exp_oh_xs, exp_ys, exp_vecs) = load_os_data([gen_data],
                                                                   total_session=np.arange(session_num),
                                                                    train_session=np.arange(session_idx+1),
                ...
                if epoch % 200 == 0 :
                    with torch.no_grad() :
                        ...
                        df_result.to_csv(os.path.join("model_profiling",
                                                      var_tar,
                                                      "profiling_exp_{}_{}_{}_{}_{}_{}.csv".format(model, args.dropout,
                                                                                                var_tar, os_i, session_idx, seed)))
